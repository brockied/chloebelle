...
// Handle new post creation with multiple photos
...
<head>
    ...
    <style>
       ...
       .premium-blur {
        ...
        /* Better heights for viewing full image content */
                        ...
                        <div class="post-card" data-post-id="<?= $post['id'] ?>">
                            <div class="card-body">
                                ...
                                <?php elseif ($post['media_url'] && !$hasAccess && $post['is_premium']): ?>
                                    <?php $mediaUrls = getMediaUrls($post['media_url']); ?>    
                                    <!-- Blurred preview for premium media -->
                                    <div class="premium-overlay" style="margin: 15px 0;">
                                        <div class="premium-blur">
                                            <?php if ($post['media_type'] === 'image' && !empty($mediaUrls)): ?>
                                                <img src="<?= htmlspecialchars($mediaUrls[0]) ?>" 
                                                     style="width: 100%; max-height: 300px; object-fit: cover; border-radius: 15px; filter: blur(15px);"
                                                     alt="Premium content">
                                            <?php elseif ($post['media_type'] === 'video' && !empty($mediaUrls)): ?>
