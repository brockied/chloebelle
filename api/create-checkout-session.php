...
if (!defined('STRIPE_SECRET_KEY')) {
    ...
    define('STRIPE_SECRET_KEY', 'sk_test_your_secret_key_here'); // Replace with your actual secret key
    define('STRIPE_PUBLISHABLE_KEY', 'pk_test_your_publishable_key_here'); // Replace with your actual publishable key
